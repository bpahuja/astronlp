...
INPUT_PROFILES_FILE = 'cluster_out_v1/paper_bag_of_methods.csv'
...
SVD_COMPONENTS = 600  # Reduce from potentially thousands of features
...
# Output file paths
OUTPUT_CSV_FILE = 'full/final_paper_families_hdbscan.csv'
OUTPUT_PLOT_2D_FILE = 'full/families_visualization_2d_hdbscan.png'
OUTPUT_PLOT_3D_FILE = 'full/families_visualization_3d_hdbscan.html'
